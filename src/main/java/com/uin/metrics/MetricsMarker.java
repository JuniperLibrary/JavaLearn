...
//  public static final io.dropwizard.metrics5.MetricRegistry metricRegistry5 = io.dropwizard.metrics5.SharedMetricRegistries.getOrCreate("Metric5");
//
//  private static final long default_time = 300;//默认时间段为300秒
//
//
//  /**
//   * Metrics5 Gauge with Tag
//   *
//   * @param name   指标名
//   * @param tagMap 标签
//   */
//  public static void setGauge(String name, Map<String, String> tagMap, io.dropwizard.metrics5.Gauge gauge) {
//    if (!enable) {
//      return;
//    }
//    MetricName metricName = io.dropwizard.metrics5.MetricRegistry.name(name).tagged(tagMap);
//    metricRegistry5.register(metricName, gauge);
//  }
//
//  /**
//   * Metrics5 Counter(inc) with Tag
//   *
//   * @param name   指标名
//   * @param tagMap 标签
//   * @param count  数量
//   */
//  public static void incCounter(String name, Map<String, String> tagMap, long count) {
//    if (!enable) {
//      return;
//    }
//    MetricName metricName = io.dropwizard.metrics5.MetricRegistry.name(name).tagged(tagMap);
//    metricRegistry5.counter(metricName).inc(count);
//  }
//
//  /**
//   * Metrics5 Counter(dec) with Tag
//   *
//   * @param name   指标名
//   * @param tagMap 标签
//   * @param count  数量
//   */
//  public static void decCounter(String name, Map<String, String> tagMap, long count) {
//    if (!enable) {
//      return;
//    }
//    MetricName metricName = io.dropwizard.metrics5.MetricRegistry.name(name).tagged(tagMap);
//    metricRegistry5.counter(metricName).dec(count);
//  }
//
//  /**
//   * Metrics5 Timer with Tag
//   *
//   * @param name     指标名
//   * @param duration 耗时
//   * @param timeUnit 时间单位
//   * @param tagMap   标签
//   */
//  public static void updateTimer(String name, long duration, TimeUnit timeUnit, Map<String, String> tagMap) {
//    MetricName metricName = io.dropwizard.metrics5.MetricRegistry.name(name).tagged(tagMap);
//    metricRegistry5.timer(metricName).update(duration, timeUnit);
//  }
//
//  public static io.dropwizard.metrics5.Timer.Context startTimer(String name, Map<String, String> tagMap) {
//    MetricName metricName = io.dropwizard.metrics5.MetricRegistry.name(name).tagged(tagMap);
//    return metricRegistry5.timer(metricName).time();
//  }
//
//  /**
//   * Metrics.Gauge埋点
